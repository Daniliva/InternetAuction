...
namespace InternetAuction.DAL.MSSQL.Migrations
{
    ...
    [Migration("20220713100146_CorrectNameing2")]
    partial class CorrectNameing2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternetAuction.DAL.Entities.MSSQL.RoleUser", b =>
                {
                    b.HasOne("InternetAuction.DAL.Entities.MSSQL.Role", "Roles")
                        .WithMany("RoleUsers")
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InternetAuction.DAL.Entities.MSSQL.User", "Users")
                        .WithMany("RoleUsers")
